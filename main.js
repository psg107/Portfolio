...
function renderSocialLinks() {
  ...
  container.innerHTML = `
    ...
    <a href="${contact.velog}" target="_blank" class="social-link social-link--velog" aria-label="Velog">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true">
        <path d="M7.2 6.5L9.8 17.5L17.2 7.2" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"/>
      </svg>
    </a>
